...
<body class="padTop53" style="background:url(themes/images/bg.png)">
	...
	<header>
		<h5><font color="white">Masukan data Produk baru</font></h5>
	</header>
		<div class="body">
		<?php 
		include ('koneksi.php');
...
$np= $_POST["np"];
$ft= $_FILES["ft"]["name"];
$perintah = "insert into produk (namaproduk,foto) value ('$np','$ip$ft')";

$simpan = mysql_query($perintah,$koneksi);
if($simpan){
move_uploaded_file( $_FILES["ft"]["tmp_name"],"fotoproduk/".$ip.$ft);
echo("<script>
		

swal('Selamat!', 'Data produk sukses tersimpan', 'success');
				
		</script>");
			echo "<center><div class='alert alert-success alert-dismissable'>
                  <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>
					<b>Berhasil menambah data Produk!!</b>
			</div><center>
...
echo "<center><div class='alert alert-warning alert-dismissable'>
                  <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>
					<b>Gagal menambah data Produk!!</b>
			</div><center>";
}
}
?>
			<form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
						...
						<div class="form-group">
							...
							<div class="col-lg-4">
								<input type="text" name="np" autofocus="" required="" class="form-control">
							</div>
						</div>
