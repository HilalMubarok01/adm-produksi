...
$konfirmasi=md5($_POST["konfirmasi"]);
	$tampil = "select * from admin where email='$em' and password='$lama'";
...
if($baru == $konfirmasi)
{
$perintah = "update admin set password='$baru' where email='$em'";
...
swal('Selamat!', 'Kata sandi berhasi diganti', 'success');
...
swal('Maaf!', 'Kata sandi baru dan konfirmasi berbeda', 'warning');
...
swal('Maaf!', 'Kata sandi lama salah', 'warning');
...
?>
			...
			<form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
						<div class="form-group">
							<label class="control-label col-lg-4">Email Admin</label>
							<div class="col-lg-4">
								<label><?php echo $_GET['em']; ?></label>
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-lg-4">Kata Sandi Lama</label>
							<div class="col-lg-4">
								<input type="password" name="lama" class="form-control">
							</div>
						</div>
                        <div class="form-group">
							<label class="control-label col-lg-4">Kata Sandi Baru</label>
							<div class="col-lg-4">
								<input type="password" name="baru" class="form-control">
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-lg-4">Konfirmasi Kata Sandi Baru</label>
							<div class="col-lg-4">
								<input type="password" name="konfirmasi" class="form-control">
							</div>
						</div>
						<div class="form-actions no-margin-bottom" style="text-align:center;">
							<input type="submit" name="btn" value="Ganti" class="btn btn-success"> <a href="admin.php" class="btn btn-warning">Kembali</a>
						</div>
